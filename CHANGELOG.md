...
- Updated registry1.dso.mil/ironbank/opensource/istio/operator from 1.23.5 to 1.23.6
- Updated registry1.dso.mil/ironbank/tetrate/istio/operator from 1.23.5-tetratefips-v0 to 1.23.6-tetratefips-v0
...
- Updated repo1 image to `1.18.1`
- Updated TID image to `1.18.0`

## [1.17.3-bb.0]

### Added

- Updated repo1 image to `1.17.3`
- Updated TID image to `1.17.3`
...
- Updated repo1 image to `1.14.3`
- Synced chart with new upstream version

## [1.14.2-bb.0]

### Changed

- Updated repo1 image to `1.14.2`
